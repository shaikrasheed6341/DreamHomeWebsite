        ...
        <div className="flex flex-col justify-center space-y-6 md:ml-6 lg:ml-8">
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            <div>
              ...
              <p className="text-base sm:text-lg underline text-[#2B1B12]">Houses Available</p>
            </div>
            <div>
              <p className="text-3xl sm:text-4xl font-bold text-[#2B1B12]">8K+</p>
              <p className="text-base sm:text-lg underline text-[#2B1B12]">Houses Sold</p>
            </div>
            <div>
              <p className="text-3xl sm:text-4xl font-bold text-[#2B1B12]">8K+</p>
              <p className="text-base sm:text-lg underline text-[#2B1B12]">Trusted Agents</p>
            </div>
          </div>
        </div>
      </div>
